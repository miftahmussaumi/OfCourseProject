...
public class belum extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_belum);
        ...
        buttonselesai.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(belum.this, sudah.class);
        ...
        buttonsedangdiproses.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(belum.this, belum.class);
                startActivity(intent);
            }
        });
        recyclerView = findViewById(R.id.rv_belum);
        list = new ArrayList<>();
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        sessionManager = new SessionManager(belum.this);
        String id_users = sessionManager.getUserDetail().get(SessionManager.ID);

        ApiInterface apiInterface = ApiClient.getClient().create(ApiInterface.class);
        Call<List<ResponseTransaksi>> call = apiInterface.getTransaksiBelum(id_users);
        call.enqueue(new Callback<List<ResponseTransaksi>>() {
            ...
            public void onResponse(Call<List<ResponseTransaksi>> call, Response<List<ResponseTransaksi>> response) {
                list = response.body();
                transaksi1Adapter = new Transaksi1Adapter(list,belum.this);
